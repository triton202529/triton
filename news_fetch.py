...
POS = set(
    "beat beats surges record upgrade bullish strong growth jumps rally profit profits upside gain gains".split()
)
NEG = set(
    "miss misses plunges downgrade bearish weak slump falls lawsuit probe cut cuts downside loss losses".split()
)
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        "--fill-missing",
        action="store_true",
        help="Add neutral placeholder rows for tickers with no hits",
    )
