...
class Layer(JSONMixin):
    ...
    def _prepare_binary_data(self, data_set):
        ...
        inverted_accessor_map = {
            v: k for k, v in layer_accessors.items() if type(v) not in [list, dict, set]
        }
    ...
    def _add_default_layer_attributes(self, kwargs):
        ...
        if (
            ...
            and self.type in attributes
            and isinstance(attributes[self.type], dict)
        ):
