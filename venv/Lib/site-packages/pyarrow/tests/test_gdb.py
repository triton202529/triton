...
gdb_script = os.environ.get("ARROW_GDB_SCRIPT") or os.path.join(
    here, "../../../cpp/gdb_arrow.py"
)
...
class GdbSession:
    ...
    def wait_until_ready(self):
        ...
        # TODO: add timeout?
        while (
            not self.last_stdout_line.startswith(b"(gdb) ") and self.proc.poll() is None
        ):
...
def test_status(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow, "error_status", 'arrow::Status::IOError("This is an error")'
    )
    check_stack_repr(
        gdb_arrow,
        "error_detail_status",
...
def test_buffer_stack(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow, "buffer_abc", 'arrow::Buffer of size 3, read-only, "abc"'
    )
    check_stack_repr(
        gdb_arrow,
        "buffer_special_chars",
        r'arrow::Buffer of size 12, read-only, "foo\"bar\000\r\n\t\037"',
    )
    check_stack_repr(
        gdb_arrow, "buffer_mutable", 'arrow::MutableBuffer of size 3, mutable, "abc"'
    )


def test_buffer_heap(gdb_arrow):
    check_heap_repr(
        gdb_arrow, "heap_buffer", 'arrow::Buffer of size 3, read-only, "abc"'
    )
    check_heap_repr(
        gdb_arrow,
        "heap_buffer_mutable.get()",
...
def test_decimals(gdb_arrow):
    ...
    check_stack_repr(gdb_arrow, "decimal128_pos", f"arrow::Decimal128({v128})")
    check_stack_repr(gdb_arrow, "decimal128_neg", f"arrow::Decimal128(-{v128})")
    check_stack_repr(gdb_arrow, "basic_decimal128_zero", "arrow::BasicDecimal128(0)")
    check_stack_repr(
        gdb_arrow, "basic_decimal128_pos", f"arrow::BasicDecimal128({v128})"
    )
    check_stack_repr(
        gdb_arrow, "basic_decimal128_neg", f"arrow::BasicDecimal128(-{v128})"
    )
    ...
    check_stack_repr(gdb_arrow, "decimal256_pos", f"arrow::Decimal256({v256})")
    check_stack_repr(gdb_arrow, "decimal256_neg", f"arrow::Decimal256(-{v256})")
    check_stack_repr(gdb_arrow, "basic_decimal256_zero", "arrow::BasicDecimal256(0)")
    check_stack_repr(
        gdb_arrow, "basic_decimal256_pos", f"arrow::BasicDecimal256({v256})"
    )
    check_stack_repr(
        gdb_arrow, "basic_decimal256_neg", f"arrow::BasicDecimal256(-{v256})"
    )


def test_metadata(gdb_arrow):
    check_heap_repr(
        gdb_arrow, "empty_metadata.get()", "arrow::KeyValueMetadata of size 0"
    )
    check_heap_repr(
        gdb_arrow,
        "metadata.get()",
...
def test_types_stack(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow, "timestamp_type_s", "arrow::timestamp(arrow::TimeUnit::SECOND)"
    )
    check_stack_repr(
        gdb_arrow,
        "timestamp_type_ms_timezone",
        'arrow::timestamp(arrow::TimeUnit::MILLI, "Europe/Paris")',
    )
    check_stack_repr(
        gdb_arrow, "timestamp_type_us", "arrow::timestamp(arrow::TimeUnit::MICRO)"
    )
    check_stack_repr(
        gdb_arrow,
    ...
    check_stack_repr(
        gdb_arrow, "month_day_nano_interval_type", "arrow::month_day_nano_interval()"
    )
    check_stack_repr(
        gdb_arrow, "duration_type_s", "arrow::duration(arrow::TimeUnit::SECOND)"
    )
    check_stack_repr(
        gdb_arrow, "duration_type_ns", "arrow::duration(arrow::TimeUnit::NANO)"
    )
    ...
    check_stack_repr(
        gdb_arrow, "fixed_size_binary_type", "arrow::fixed_size_binary(10)"
    )

    check_stack_repr(gdb_arrow, "list_type", "arrow::list(arrow::uint8())")
    check_stack_repr(
        gdb_arrow, "large_list_type", "arrow::large_list(arrow::large_utf8())"
    )
    check_stack_repr(
        gdb_arrow, "fixed_size_list_type", "arrow::fixed_size_list(arrow::float64(), 3)"
    )
    check_stack_repr(
        gdb_arrow,
        "map_type_unsorted",
...
def test_types_heap(gdb_arrow):
    ...
    check_heap_repr(
        gdb_arrow, "heap_time_type_ns", "arrow::time64(arrow::TimeUnit::NANO)"
    )
    check_heap_repr(
        gdb_arrow,
        "heap_timestamp_type_ns_timezone",
        'arrow::timestamp(arrow::TimeUnit::NANO, "Europe/Paris")',
    )
    ...
    check_heap_repr(
        gdb_arrow, "heap_large_list_type", "arrow::large_list(arrow::large_utf8())"
    )
    check_heap_repr(
        gdb_arrow,
        "heap_fixed_size_list_type",
...
def test_scalars_stack(gdb_arrow):
    ...
    check_stack_repr(
        gdb_arrow, "bool_scalar_null", "arrow::BooleanScalar of null value"
    )
    ...
    check_stack_repr(
        gdb_arrow, "int64_scalar", "arrow::Int64Scalar of value -9223372036854775808"
    )
    check_stack_repr(
        gdb_arrow, "uint64_scalar", "arrow::UInt64Scalar of value 18446744073709551615"
    )
    check_stack_repr(
        gdb_arrow, "half_float_scalar", "arrow::HalfFloatScalar of value -1.5 [48640]"
    )
    ...
    check_stack_repr(
        gdb_arrow, "time_scalar_us", "arrow::Time64Scalar of value 10000us"
    )
    check_stack_repr(
        gdb_arrow, "time_scalar_ns", "arrow::Time64Scalar of value 100000ns"
    )
    check_stack_repr(
        gdb_arrow, "time_scalar_null", "arrow::Time64Scalar of null value [ns]"
    )

    check_stack_repr(
        gdb_arrow, "duration_scalar_s", "arrow::DurationScalar of value -100s"
    )
    check_stack_repr(
        gdb_arrow, "duration_scalar_ms", "arrow::DurationScalar of value -1000ms"
    )
    check_stack_repr(
        gdb_arrow, "duration_scalar_us", "arrow::DurationScalar of value -10000us"
    )
    check_stack_repr(
        gdb_arrow, "duration_scalar_ns", "arrow::DurationScalar of value -100000ns"
    )
    check_stack_repr(
        gdb_arrow, "duration_scalar_null", "arrow::DurationScalar of null value [ns]"
    )
    ...
    check_stack_repr(
        gdb_arrow,
        "month_day_nano_interval_scalar_null",
        "arrow::MonthDayNanoIntervalScalar of null value",
    )

    check_stack_repr(
        gdb_arrow, "date32_scalar", "arrow::Date32Scalar of value 23d [1970-01-24]"
    )
    check_stack_repr(
        gdb_arrow, "date32_scalar_null", "arrow::Date32Scalar of null value"
    )
    check_stack_repr(
        gdb_arrow,
        "date64_scalar",
    ...
    check_stack_repr(
        gdb_arrow, "date64_scalar_null", "arrow::Date64Scalar of null value"
    )

    check_stack_repr(
        gdb_arrow,
        "decimal128_scalar_null",
        "arrow::Decimal128Scalar of null value [precision=10, scale=4]",
    )
    check_stack_repr(
        gdb_arrow,
        "decimal128_scalar_pos_scale_pos",
        "arrow::Decimal128Scalar of value 123.4567 [precision=10, scale=4]",
    )
    check_stack_repr(
        gdb_arrow,
        "decimal128_scalar_pos_scale_neg",
        "arrow::Decimal128Scalar of value -123.4567 [precision=10, scale=4]",
    )
    check_stack_repr(
        gdb_arrow,
        "decimal128_scalar_neg_scale_pos",
        ("arrow::Decimal128Scalar of value 1.234567e+10 " "[precision=10, scale=-4]"),
    )
    check_stack_repr(
        gdb_arrow,
        "decimal128_scalar_neg_scale_neg",
        ("arrow::Decimal128Scalar of value -1.234567e+10 " "[precision=10, scale=-4]"),
    )

    check_stack_repr(
        gdb_arrow,
        "decimal256_scalar_null",
    ...
    check_stack_repr(
        gdb_arrow,
        "decimal256_scalar_pos_scale_neg",
        (
            "arrow::Decimal256Scalar of value "
            "-123456789012345678901234567890123456789012.3456 "
            "[precision=50, scale=4]"
    ...
    check_stack_repr(
        gdb_arrow,
        "decimal256_scalar_neg_scale_pos",
        (
            "arrow::Decimal256Scalar of value "
    ...
    check_stack_repr(
        gdb_arrow,
        "decimal256_scalar_neg_scale_neg",
        (
            "arrow::Decimal256Scalar of value "
            "-1.234567890123456789012345678901234567890123456e+49 "
            "[precision=50, scale=-4]"
    ...
    check_stack_repr(
        gdb_arrow, "binary_scalar_null", "arrow::BinaryScalar of null value"
    )
    check_stack_repr(
        gdb_arrow,
        "binary_scalar_unallocated",
        "arrow::BinaryScalar of value <unallocated>",
    )
    check_stack_repr(
        gdb_arrow, "binary_scalar_empty", 'arrow::BinaryScalar of size 0, value ""'
    )
    check_stack_repr(
        gdb_arrow, "binary_scalar_abc", 'arrow::BinaryScalar of size 3, value "abc"'
    )
    check_stack_repr(
        gdb_arrow,
        "binary_scalar_bytes",
    ...
    check_stack_repr(
        gdb_arrow,
        "large_binary_scalar_abc",
        'arrow::LargeBinaryScalar of size 3, value "abc"',
    )

    check_stack_repr(
        gdb_arrow, "string_scalar_null", "arrow::StringScalar of null value"
    )
    check_stack_repr(
        gdb_arrow,
        "string_scalar_unallocated",
        "arrow::StringScalar of value <unallocated>",
    )
    check_stack_repr(
        gdb_arrow, "string_scalar_empty", 'arrow::StringScalar of size 0, value ""'
    )
    check_stack_repr(
        gdb_arrow, "string_scalar_hehe", 'arrow::StringScalar of size 6, value "héhé"'
    )
    # FIXME: excessive escaping ('\\xff' vs. '\x00')
    check_stack_repr(
        gdb_arrow,
        "string_scalar_invalid_chars",
        r'arrow::StringScalar of size 11, value "abc\x00def\\xffghi"',
    )
    check_stack_repr(
        gdb_arrow,
        "large_string_scalar_hehe",
...
def test_scalars_heap(gdb_arrow):
    ...
    check_heap_repr(
        gdb_arrow,
        "heap_decimal128_scalar",
        "arrow::Decimal128Scalar of value 123.4567 [precision=10, scale=4]",
    )
    check_heap_repr(
        gdb_arrow,
        "heap_decimal256_scalar",
        (
            "arrow::Decimal256Scalar of value "
            "123456789012345678901234567890123456789012.3456 "
            "[precision=50, scale=4]"
...
def test_arrays_heap(gdb_arrow):
    ...
    check_heap_repr(
        gdb_arrow,
        "heap_month_day_nano_interval_array",
        (
    ...
    check_heap_repr(
        gdb_arrow,
        "heap_fixed_size_binary_array_zero_width",
        (
    ...
    check_heap_repr(
        gdb_arrow,
        "heap_fixed_size_binary_array_sliced",
        (
            r"arrow::FixedSizeBinaryArray of type arrow::fixed_size_binary(3), "
...
def test_schema(gdb_arrow):
    check_heap_repr(gdb_arrow, "schema_empty", "arrow::Schema with 0 fields")
    check_heap_repr(
        gdb_arrow,
        "schema_non_empty",
        (
...
def test_datum(gdb_arrow):
    ...
    check_stack_repr(
        ...
        "batch_datum",
        re.compile(
            r"^arrow::Datum of value arrow::RecordBatch " r"with 2 columns, 3 rows "
        ),
    )
    check_stack_repr(
        gdb_arrow,
        "table_datum",
        re.compile(r"^arrow::Datum of value arrow::Table " r"with 2 columns, 5 rows "),
    )
