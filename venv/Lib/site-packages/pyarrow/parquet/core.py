...
class ParquetFile:
    ...
    def read_row_group(
        self, i, columns=None, use_threads=True, use_pandas_metadata=False
    ):
        """
        ...
        return self.reader.read_row_group(
            i, column_indices=column_indices, use_threads=use_threads
        )

    def read_row_groups(
        self, row_groups, columns=None, use_threads=True, use_pandas_metadata=False
    ):
        """
        ...
        return self.reader.read_row_groups(
            row_groups, column_indices=column_indices, use_threads=use_threads
        )
    ...
    def _get_column_indices(self, column_names, use_pandas_metadata=False):
        ...
        if use_pandas_metadata:
            ...
            if indices is not None and index_columns:
                indices += [
                    self.reader.column_name_idx(descr)
    ...
    if "spark" in flavor:
        ...
        for field in schema:
            ...
            if sanitized_name != name:
                schema_changed = True
                sanitized_field = pa.field(
                    sanitized_name, field.type, field.nullable, field.metadata
                )
...
"""
    ...
    def __init__(
        ...
        *,
        ...
        if buffer_size:
            read_options.update(use_buffered_stream=True, buffer_size=buffer_size)
    ...
    def equals(self, other):
        ...
        return (
            ...
            and self._dataset.format == other._dataset.format
    ...
    def read(self, columns=None, use_threads=True, use_pandas_metadata=False):
        ...
        table = self._dataset.to_table(
            columns=columns, filter=self._filter_expression, use_threads=use_threads
        )
...
def read_pandas(source, columns=None, **kwargs):
    return read_table(source, columns=columns, use_pandas_metadata=True, **kwargs)
...
def read_schema(where, memory_map=False, decryption_properties=None, filesystem=None):
    """
