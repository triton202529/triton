...
from alpaca_trade_api.entity_v2 import (
    BarsV2,
    QuotesV2,
    TradesV2,
    EntityList,
...
class AsyncRest:
    ...
    async def _iterate_requests(
        self, symbol, payload, limit, entity_type: str, entity_list_type: EntityList
    ) -> pd.DataFrame:
        """
    ...
    async def get_bars_async(
        self, symbol, start, end, timeframe, limit=1000, adjustment="raw"
    ):
        _type = "bars"
        ...
        df = await self._iterate_requests(symbol, payload, limit, _type, BarsV2)
    ...
    async def get_trades_async(self, symbol, start, end, limit=1000):
        ...
        df = await self._iterate_requests(symbol, payload, limit, _type, TradesV2)
    ...
    async def get_quotes_async(self, symbol, start, end, limit=1000):
        ...
        df = await self._iterate_requests(symbol, payload, limit, _type, QuotesV2)
