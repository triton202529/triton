...
class REST(object):
    ...
    def data_get(self, path, data=None, feed: Optional[str] = None, api_version="v1"):
    ...
    def _data_get(
        ...
        **kwargs,
        ...
        is_multi_symbol = api_version == "v1beta3" or not isinstance(
        ...
        while True:
            ...
            if endpoint:
                path += f"/{endpoint}"
            resp = self.data_get(path, data=data, feed=feed, api_version=api_version)
    ...
    def get_latest_bar(self, symbol: str, feed: Optional[str] = None) -> BarV2:
        resp = self.data_get(
            "/stocks/{}/bars/latest".format(symbol), feed=feed, api_version="v2"
        )
    ...
    def get_latest_trade(self, symbol: str, feed: Optional[str] = None) -> TradeV2:
        resp = self.data_get(
            "/stocks/{}/trades/latest".format(symbol), feed=feed, api_version="v2"
        )
    ...
    def get_latest_quote(self, symbol: str, feed: Optional[str] = None) -> QuoteV2:
        resp = self.data_get(
            "/stocks/{}/quotes/latest".format(symbol), feed=feed, api_version="v2"
        )
    ...
    def get_snapshot(self, symbol: str, feed: Optional[str] = None) -> SnapshotV2:
        resp = self.data_get(
            "/stocks/{}/snapshot".format(symbol), feed=feed, api_version="v2"
        )
    ...
    def get_latest_crypto_bars(
        self, symbols: List[str], loc: str = "us"
    ) -> LatestBarsV2:
        resp = self.data_get(
    ...
    def get_crypto_snapshot(self, symbols: str, loc: str = "us") -> SnapshotsV2:
        resp = self.data_get(
            f"/crypto/{loc}/snapshots", data={"symbols": symbols}, api_version="v1beta3"
        )
    ...
    def get_latest_crypto_orderbooks(
        self, symbols: List[str], loc: str = "us"
    ) -> OrderbookV2:
        resp = self.data_get(
            f"/crypto/{loc}/latest/orderbooks",
