...
class NewsApiClient(object):
    ...
    def get_top_headlines(  # noqa: C901
        ...
        r = self.request_method.get(
            const.TOP_HEADLINES_URL, auth=self.auth, timeout=30, params=payload
        )
    ...
    def get_everything(  # noqa: C901
        ...
        # Send Request
        r = self.request_method.get(
            const.EVERYTHING_URL, auth=self.auth, timeout=30, params=payload
        )
    ...
    def get_sources(self, category=None, language=None, country=None):  # noqa: C901
        ...
        # Send Request
        r = self.request_method.get(
            const.SOURCES_URL, auth=self.auth, timeout=30, params=payload
        )
