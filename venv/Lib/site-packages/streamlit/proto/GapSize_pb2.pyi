...
class _GapSizeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_GapSize.ValueType],
    builtins.type,
):
...
class GapConfig(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["gap_size", b"gap_size", "gap_spec", b"gap_spec"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal["gap_size", b"gap_size", "gap_spec", b"gap_spec"],
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["gap_spec", b"gap_spec"]
    ) -> typing.Literal["gap_size"] | None: ...
