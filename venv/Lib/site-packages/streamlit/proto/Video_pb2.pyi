...
class SubtitleTrack(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["label", b"label", "url", b"url"]
    ) -> None: ...
...
class Video(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_width_config", b"_width_config", "width_config", b"width_config"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
