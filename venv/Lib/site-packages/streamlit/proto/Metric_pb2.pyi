...
class Metric(google.protobuf.message.Message):
    ...
    class _MetricDirectionEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            Metric._MetricDirection.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class MetricDirection(
        _MetricDirection, metaclass=_MetricDirectionEnumTypeWrapper
    ): ...
    ...
    def HasField(
        self, field_name: typing.Literal["label_visibility", b"label_visibility"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
