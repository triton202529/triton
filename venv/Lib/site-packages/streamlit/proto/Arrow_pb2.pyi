...
class Arrow(google.protobuf.message.Message):
    ...
    class _SelectionModeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            Arrow._SelectionMode.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def selection_mode(
        ...
        global___Arrow.SelectionMode.ValueType
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        selection_mode: (
            collections.abc.Iterable[global___Arrow.SelectionMode.ValueType] | None
        ) = ...,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_row_height", b"_row_height"]
    ) -> typing.Literal["row_height"] | None: ...
