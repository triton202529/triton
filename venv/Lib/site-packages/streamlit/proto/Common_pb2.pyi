...
class StringTriggerValue(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["_data", b"_data", "data", b"data"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["_data", b"_data", "data", b"data"]
    ) -> None: ...
...
class UploadedFileInfo(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["file_urls", b"file_urls"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class FileUploaderState(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        max_file_id: builtins.int = ...,
        uploaded_file_info: (
            collections.abc.Iterable[global___UploadedFileInfo] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "max_file_id", b"max_file_id", "uploaded_file_info", b"uploaded_file_info"
        ],
    ) -> None: ...
...
class ChatInputValue(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_data",
            b"_data",
            "_file_uploader_state",
            b"_file_uploader_state",
            "data",
            b"data",
            "file_uploader_state",
            b"file_uploader_state",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self,
        oneof_group: typing.Literal["_file_uploader_state", b"_file_uploader_state"],
    ) -> typing.Literal["file_uploader_state"] | None: ...
