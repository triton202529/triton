...
class ComponentInstance(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_tab_index", b"_tab_index", "tab_index", b"tab_index"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_tab_index", b"_tab_index"]
    ) -> typing.Literal["tab_index"] | None: ...
...
class SpecialArg(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "arrow_dataframe", b"arrow_dataframe", "bytes", b"bytes", "value", b"value"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    ) -> typing.Literal["arrow_dataframe", "bytes"] | None: ...
...
class ArrowDataframe(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "data", b"data", "height", b"height", "width", b"width"
        ],
    ) -> None: ...
...
class ArrowTable(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["styler", b"styler"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
