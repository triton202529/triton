...
class PlotlyChart(google.protobuf.message.Message):
    ...
    class _SelectionModeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            PlotlyChart._SelectionMode.ValueType
        ],
        builtins.type,
    ):
    ...
    def selection_mode(
        ...
        global___PlotlyChart.SelectionMode.ValueType
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        id: builtins.str = ...,
        selection_mode: (
            collections.abc.Iterable[global___PlotlyChart.SelectionMode.ValueType]
            | None
        ) = ...,
        form_id: builtins.str = ...,
        spec: builtins.str = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "chart", b"chart", "figure", b"figure", "url", b"url"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["chart", b"chart"]
    ) -> typing.Literal["url", "figure"] | None: ...
...
class Figure(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["config", b"config", "spec", b"spec"]
    ) -> None: ...
