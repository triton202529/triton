...
class ContextInfo(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_color_scheme", b"_color_scheme"]
    ) -> typing.Literal["color_scheme"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_is_embedded", b"_is_embedded"]
    ) -> typing.Literal["is_embedded"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_locale", b"_locale"]
    ) -> typing.Literal["locale"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_timezone", b"_timezone"]
    ) -> typing.Literal["timezone"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_timezone_offset", b"_timezone_offset"]
    ) -> typing.Literal["timezone_offset"] | None: ...
    @typing.overload
    def WhichOneof(
...
class ClientState(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "context_info", b"context_info", "widget_states", b"widget_states"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
