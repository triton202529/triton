...
class LabelVisibilityMessage(google.protobuf.message.Message):
    ...
    class _LabelVisibilityOptionsEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            LabelVisibilityMessage._LabelVisibilityOptions.ValueType
        ],
        builtins.type,
    ):
    ...
    class LabelVisibilityOptions(
        _LabelVisibilityOptions, metaclass=_LabelVisibilityOptionsEnumTypeWrapper
    ):
