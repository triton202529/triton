...
class DataFrame(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "columns", b"columns", "data", b"data", "index", b"index", "style", b"style"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MultiIndex(google.protobuf.message.Message):
    ...
    def labels(
        ...
        streamlit.proto.Common_pb2.Int32Array
    ]: ...
    def __init__(
        self,
        *,
        ...
        labels: (
            collections.abc.Iterable[streamlit.proto.Common_pb2.Int32Array] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["labels", b"labels", "levels", b"levels"]
    ) -> None: ...
...
class CSSStyle(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["property", b"property", "value", b"value"]
    ) -> None: ...
...
class AnyArray(google.protobuf.message.Message):
    ...
    def WhichOneof(
        ...
        typing.Literal["strings", "doubles", "int64s", "datetimes", "timedeltas"] | None
    ): ...
