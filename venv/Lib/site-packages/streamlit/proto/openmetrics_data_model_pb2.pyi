...
class MetricSet(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["metric_families", b"metric_families"]
    ) -> None: ...
...
class Metric(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "labels", b"labels", "metric_points", b"metric_points"
        ],
    ) -> None: ...
...
class UnknownValue(google.protobuf.message.Message):
    ...
    ) -> typing.Literal["double_value", "int_value"] | None: ...
...
class CounterValue(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["total", b"total"]
    ) -> typing.Literal["double_value", "int_value"] | None: ...
...
class HistogramValue(google.protobuf.message.Message):
    ...
    class Bucket(google.protobuf.message.Message):
        ...
        def HasField(
            self, field_name: typing.Literal["exemplar", b"exemplar"]
        ) -> builtins.bool: ...
        def ClearField(
            self,
            field_name: typing.Literal[
    ...
    def buckets(
        ...
        global___HistogramValue.Bucket
    ]:
        """Optional."""
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["sum", b"sum"]
    ) -> typing.Literal["double_value", "int_value"] | None: ...
...
class Exemplar(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "label", b"label", "timestamp", b"timestamp", "value", b"value"
        ],
    ) -> None: ...
...
class StateSetValue(google.protobuf.message.Message):
    ...
    class State(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing.Literal["enabled", b"enabled", "name", b"name"]
        ) -> None: ...
...
class SummaryValue(google.protobuf.message.Message):
    ...
    class Quantile(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing.Literal["quantile", b"quantile", "value", b"value"]
        ) -> None: ...
    ...
    def quantile(
        ...
        global___SummaryValue.Quantile
    ]:
        """Optional."""
