...
class Block(google.protobuf.message.Message):
    ...
    class Vertical(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing.Literal["border", b"border", "height", b"height"]
        ) -> None: ...
    ...
    class FlexContainer(google.protobuf.message.Message):
        ...
        class _DirectionEnumTypeWrapper(
            google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
                Block.FlexContainer._Direction.ValueType
            ],
            builtins.type,
        ):
        ...
        def HasField(
            self, field_name: typing.Literal["gap_config", b"gap_config"]
        ) -> builtins.bool: ...
        def ClearField(
            self,
    ...
    class Column(google.protobuf.message.Message):
        ...
        class _VerticalAlignmentEnumTypeWrapper(
            google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
                Block.Column._VerticalAlignment.ValueType
            ],
            builtins.type,
        ):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        ...
        class VerticalAlignment(
            _VerticalAlignment, metaclass=_VerticalAlignmentEnumTypeWrapper
        ): ...
        ...
        def HasField(
            self,
            field_name: typing.Literal[
                "_gap_config", b"_gap_config", "gap_config", b"gap_config"
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
        ...
        def WhichOneof(
            self, oneof_group: typing.Literal["_gap_config", b"_gap_config"]
        ) -> typing.Literal["gap_config"] | None: ...
    ...
    class Expandable(google.protobuf.message.Message):
        ...
        def HasField(
            self,
            field_name: typing.Literal[
                "_expanded", b"_expanded", "expanded", b"expanded"
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
        ...
        def WhichOneof(
            self, oneof_group: typing.Literal["_expanded", b"_expanded"]
        ) -> typing.Literal["expanded"] | None: ...
    ...
    class Dialog(google.protobuf.message.Message):
        ...
        def HasField(
            self,
            field_name: typing.Literal["_is_open", b"_is_open", "is_open", b"is_open"],
        ) -> builtins.bool: ...
        def ClearField(
            self,
            field_name: typing.Literal[
        ...
        def WhichOneof(
            self, oneof_group: typing.Literal["_is_open", b"_is_open"]
        ) -> typing.Literal["is_open"] | None: ...
    ...
    class ChatMessage(google.protobuf.message.Message):
        ...
        class _AvatarTypeEnumTypeWrapper(
            google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
                Block.ChatMessage._AvatarType.ValueType
            ],
            builtins.type,
        ):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        ...
        def ClearField(
            self,
            field_name: typing.Literal[
                "avatar", b"avatar", "avatar_type", b"avatar_type", "name", b"name"
            ],
        ) -> None: ...
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_height_config", b"_height_config"]
    ) -> typing.Literal["height_config"] | None: ...
    @typing.overload
    def WhichOneof(
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_width_config", b"_width_config"]
    ) -> typing.Literal["width_config"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> (
        typing.Literal[
            "vertical",
            "horizontal",
            "column",
