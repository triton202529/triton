...
class ButtonGroup(google.protobuf.message.Message):
    ...
    class _ClickModeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ButtonGroup._ClickMode.ValueType
        ],
        builtins.type,
    ):
    ...
    class _SelectionVisualizationEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ButtonGroup._SelectionVisualization.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class SelectionVisualization(
        _SelectionVisualization, metaclass=_SelectionVisualizationEnumTypeWrapper
    ): ...
    ...
    class Option(google.protobuf.message.Message):
        ...
        def HasField(
            ...
            field_name: typing.Literal[
                ...
                "_selected_content",
                b"_selected_content",
                "_selected_content_icon",
                b"_selected_content_icon",
                "content_icon",
                b"content_icon",
                "selected_content",
                b"selected_content",
                "selected_content_icon",
                b"selected_content_icon",
            ],
        ) -> builtins.bool: ...
        def ClearField(
            self,
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_content_icon", b"_content_icon"]
        ) -> typing.Literal["content_icon"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["_selected_content", b"_selected_content"]
        ) -> typing.Literal["selected_content"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
                "_selected_content_icon", b"_selected_content_icon"
            ],
        ) -> typing.Literal["selected_content_icon"] | None: ...
    ...
    def label_visibility(
        self,
    ) -> streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage: ...
    def __init__(
        self,
        *,
        id: builtins.str = ...,
        ...
        label: builtins.str = ...,
        label_visibility: (
            streamlit.proto.LabelVisibilityMessage_pb2.LabelVisibilityMessage | None
        ) = ...,
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_help", b"_help", "help", b"help", "label_visibility", b"label_visibility"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_help", b"_help"]
    ) -> typing.Literal["help"] | None: ...
