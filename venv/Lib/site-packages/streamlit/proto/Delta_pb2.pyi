...
class Delta(google.protobuf.message.Message):
    ...
    def arrow_add_rows(
        self,
    ) -> streamlit.proto.ArrowNamedDataSet_pb2.ArrowNamedDataSet: ...
    def __init__(
        self,
        *,
        ...
        arrow_add_rows: (
            streamlit.proto.ArrowNamedDataSet_pb2.ArrowNamedDataSet | None
        ) = ...,
        fragment_id: builtins.str = ...,
    ) -> None: ...
    def HasField(
    ...
    def WhichOneof(
        ...
        typing.Literal["new_element", "add_block", "add_rows", "arrow_add_rows"] | None
    ): ...
