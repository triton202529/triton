...
class DeckGlJsonChart(google.protobuf.message.Message):
    ...
    class _SelectionModeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DeckGlJsonChart._SelectionMode.ValueType
        ],
        builtins.type,
    ):
    ...
    def selection_mode(
        ...
        global___DeckGlJsonChart.SelectionMode.ValueType
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        height: builtins.int = ...,
        selection_mode: (
            collections.abc.Iterable[global___DeckGlJsonChart.SelectionMode.ValueType]
            | None
        ) = ...,
        form_id: builtins.str = ...,
    ) -> None: ...
