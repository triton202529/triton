...
class Skeleton(google.protobuf.message.Message):
    ...
    class _SkeletonStyleEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            Skeleton._SkeletonStyle.ValueType
        ],
        builtins.type,
    ):
    ...
    def HasField(
        self, field_name: typing.Literal["_height", b"_height", "height", b"height"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "_height", b"_height", "height", b"height", "style", b"style"
        ],
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_height", b"_height"]
    ) -> typing.Literal["height"] | None: ...
