...
def getpydocsign(a, var):
    ...
    if isscalar(var):
        ...
        errmess(f'getpydocsign: Could not resolve docsignature for "{a}".\n')
    return sig, sigout
...
def sign2map(a, var):
    ...
    if debugcapi(var):
        ...
        if isarray(var):
            ddim = ",".join(map(lambda x, y: f"{x}|{y}", var["dimension"], dim))
...
def cb_routsign2map(rout, um):
    ...
    """
    ret = {"name": f"cb_{rout['name']}_in_{um}", "returncptr": ""}
