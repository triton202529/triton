...
_NBit = TypeVar(
    "_NBit", bound=NBitBase, default=Any
)  # pyright: ignore[reportDeprecated]
_NBit1 = TypeVar(
    "_NBit1", bound=NBitBase, default=Any
)  # pyright: ignore[reportDeprecated]
_NBit2 = TypeVar(
    "_NBit2", bound=NBitBase, default=_NBit1
)  # pyright: ignore[reportDeprecated]
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    def __setitem__(
        ...
        key: _ToIndices,
        value: (
            _ConvertibleToInt | _NestedSequence[_ConvertibleToInt] | _ArrayLikeInt_co
        ),
        /,
    ) -> None: ...
    @overload  # floating
    ...
    def __imod__(
        self: NDArray[timedelta64],
        other: (
            _SupportsArray[_dtype[timedelta64]]
...
class matrix(ndarray[_2DShapeT_co, _DTypeT_co]):
    __array_priority__: ClassVar[float] = (
        10.0  # pyright: ignore[reportIncompatibleMethodOverride]
    )
    ...
    @overload
    def any(
        self, axis: _ShapeLike | None = None, *, out: _ArrayT
    ) -> _ArrayT: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def tolist(
        self: matrix[_2D, dtype[generic[_T]]],
    ) -> list[list[_T]]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    @overload
    def tolist(
        self,
    ) -> Incomplete: ...  # pyright: ignore[reportIncompatibleMethodOverride]
