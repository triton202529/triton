...
class RandomState:
    ...
    def randint(  # type: ignore[misc]
        ...
        size: None = ...,
        dtype: (
            dtype[ulong] | type[ulong] | _ULongCodes | _SupportsDType[dtype[ulong]]
        ) = ...,  # noqa: E501
    ) -> ulong: ...
    @overload
    def randint(  # type: ignore[misc]
    ...
    def randint(  # type: ignore[misc]
        ...
        size: None = ...,
        dtype: (
            dtype[int_] | type[int_] | _IntCodes | _SupportsDType[dtype[int_]]
        ) = ...,  # noqa: E501
    ) -> int_: ...
    @overload
    def randint(  # type: ignore[misc]
        ...
        size: None = ...,
        dtype: (
            dtype[long] | type[long] | _LongCodes | _SupportsDType[dtype[long]]
        ) = ...,  # noqa: E501
    ) -> long: ...
    @overload
    def randint(  # type: ignore[misc]
        ...
        size: None = ...,
        dtype: (
            dtype[int64] | type[int64] | _Int64Codes | _SupportsDType[dtype[int64]]
        ) = ...,  # noqa: E501
    ) -> int64: ...
    @overload
    def randint(  # type: ignore[misc]
