...
class TestGegenbauer:
    ...
    def test_n_zero_gh8888(self, a):
        ...
        assert_equal(Cn0.c, np.asarray([1.0]))
...
def test_roots_jacobi():
    ...
    vgq(
        rf(511.0, 511.0), ef(511.0, 511.0), wf(511.0, 511.0), -1.0, 1.0, 100, atol=1e-10
    )
    ...
    vgq(
        rf(511.0, 512.0), ef(511.0, 512.0), wf(511.0, 512.0), -1.0, 1.0, 100, atol=1e-10
    )
