...
INVALID_POINTS = [(1, -1), (0, 0), (-1, 1), (np.nan, 1), (1, np.nan)]
...
class TestGammainc:
    ...
    @pytest.mark.parametrize(
        "a, x, desired",
        [(np.inf, 1, 0), (np.inf, 0, 0), (np.inf, np.inf, np.nan), (1, np.inf, 1)],
    )
...
class TestGammaincc:
    ...
    @pytest.mark.parametrize(
        "a, x, desired",
        [(np.inf, 1, 1), (np.inf, 0, 1), (np.inf, np.inf, np.nan), (1, np.inf, 0)],
    )
    def test_infinite_arguments(self, a, x, desired):
