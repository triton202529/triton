...
class TestHyp2f1:
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                Hyp2f1TestCase(
                    a=0.5, b=0.2, c=-10, z=0.2 + 0.2j, expected=np.inf + 0j, rtol=0
                )
            ),
            pytest.param(
                Hyp2f1TestCase(a=0.5, b=0.2, c=-10, z=0 + 0j, expected=1 + 0j, rtol=0),
            ),
            pytest.param(
                Hyp2f1TestCase(
                    a=0.5, b=0, c=-10, z=0.2 + 0.2j, expected=1 + 0j, rtol=0
                ),
            ),
            pytest.param(
                Hyp2f1TestCase(
        ...
        [
            ...
            pytest.param(
                Hyp2f1TestCase(
                    ...
                    c=-172.1,
                    z=(1 + 0j),
                    expected=(2.2253618341394838e37 + 0j),
                    rtol=1e-13,
                ),
            ),
            pytest.param(
    ...
    def test_a_b_neg_int_after_euler_hypergeometric_transformation(
        ...
        a, b, c, z, expected, rtol = hyp2f1_test_case
        assert (abs(c - a - int(c - a)) < 1e-15 and c - a < 0) or (  # Tests the test
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                marks=pytest.mark.xfail(reason="Unhandled parameters."),
            ),
            pytest.param(
                Hyp2f1TestCase(
                    a=8.25,
            ...
            pytest.param(
                Hyp2f1TestCase(
                    ...
                    expected=(4.7724909620664006e17 - 6.039064078946702e16j),
                    rtol=5e-13,
                ),
            ),
            pytest.param(
    ...
    def test_region6(self, hyp2f1_test_case):
        ...
        a, b, c, z, expected, rtol = hyp2f1_test_case
        assert abs(z) > 1 and not (
            1 < abs(z) < 1.1 and abs(1 - z) >= 0.9 and z.real >= 0
        )
        assert_allclose(hyp2f1(a, b, c, z), expected, rtol=rtol)
