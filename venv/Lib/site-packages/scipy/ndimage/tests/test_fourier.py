...
class TestNdimageFourier:
    ...
    def test_fourier_gaussian_real01(self, shape, dtype, dec, xp):
        ...
        assert_almost_equal(ndimage.sum(a), xp.asarray(1), decimal=dec, check_0d=False)
    ...
    def test_fourier_gaussian_complex01(self, shape, dtype, dec, xp):
        ...
        assert_almost_equal(
            ndimage.sum(xp.real(a)), xp.asarray(1.0), decimal=dec, check_0d=False
        )
    ...
    def test_fourier_uniform_real01(self, shape, dtype, dec, xp):
        ...
        a = fft.irfft(a, n=shape[0], axis=0)
        assert_almost_equal(
            ndimage.sum(a), xp.asarray(1.0), decimal=dec, check_0d=False
        )
    ...
    @pytest.mark.parametrize(
        "test_func",
        [ndimage.fourier_ellipsoid, ndimage.fourier_gaussian, ndimage.fourier_uniform],
    )
