import functools
from scipy._lib._array_api import is_cupy, is_jax, scipy_namespace_for, SCIPY_ARRAY_API
...
for func_name in _ndimage_api.__all__:
    ...
    f = delegate_xp(delegator, MODULE_NAME)(bare_func) if SCIPY_ARRAY_API else bare_func
