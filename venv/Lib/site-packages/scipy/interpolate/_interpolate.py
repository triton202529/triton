    ...
    def __init__(
        ...
        if kind in ["zero", "slinear", "quadratic", "cubic"]:
            ...
            raise NotImplementedError(
                f"{kind} is unsupported: Use fitpack " "routines for other types."
            )
...
class PPoly(_PPolyBase):
    ...
    def from_bernstein_basis(cls, bp, extrapolate=None):
        ...
        if not isinstance(bp, BPoly):
            raise TypeError(
                f".from_bernstein_basis only accepts BPoly instances. "
...
class BPoly(_PPolyBase):
    ...
    def from_power_basis(cls, pp, extrapolate=None):
        ...
        if not isinstance(pp, PPoly):
            raise TypeError(
                f".from_power_basis only accepts PPoly instances. "
