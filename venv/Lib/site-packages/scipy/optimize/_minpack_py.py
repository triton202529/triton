        ...
        if output_shape[0] != 1:
            if len(output_shape) > 1:
                if output_shape[1] == 1:
                    return shape(res)
            msg = (
                f"{checker}: there is a mismatch between the input and output "
...
def _root_hybr(
    ...
    **unknown_options,
    ...
    errors = {
        ...
        2: "The number of calls to function has " f"reached maxfev = {maxfev}.",
...
def leastsq(
    ...
    if n > m:
        raise TypeError(
            f"Improper input: func input vector length N={n} must"
    ...
    errors = {
        ...
        5: [
            "Number of calls to function has reached " f"maxfev = {maxfev}.",
            ValueError,
        ],
        6: [
    ...
    **kwargs
    ...
    if method == "lm":
        ...
        if ydata.size != 1 and n > ydata.size:
            raise TypeError(
                f"The number of func parameters={n} must not"
