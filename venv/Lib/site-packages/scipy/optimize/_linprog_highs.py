...
def _highs_to_scipy_status_message(highs_status, highs_message):
    ...
    scipy_status, scipy_message = scipy_statuses_messages.get(
        highs_status, unrecognized
    )
    hstat = int(highs_status) if highs_status is not None else None
    scipy_message = f"{scipy_message}" f"(HiGHS Status {hstat}: {highs_message})"
...
def _linprog_highs(
    ...
    **unknown_options,
    ...
    simplex_dual_edge_weight_strategy_enum = _convert_to_highs_enum(
        ...
        "simplex_dual_edge_weight_strategy",
        choices={
            "dantzig": s_c.SimplexEdgeWeightStrategy.kSimplexEdgeWeightStrategyDantzig,
            "devex": s_c.SimplexEdgeWeightStrategy.kSimplexEdgeWeightStrategyDevex,
            "steepest-devex": s_c.SimplexEdgeWeightStrategy.kSimplexEdgeWeightStrategyChoose,
            "steepest": s_c.SimplexEdgeWeightStrategy.kSimplexEdgeWeightStrategySteepestEdge,
            None: None,
        },
    )
