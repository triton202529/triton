...
class TestNNLS:
    ...
    def test_nnls_gh21021_ex1(self):
        ...
        A = [
            ...
            [
                ...
                0.4422181991706678,
                -0.13720906318924858,
                -0.0069523811763796475,
                -0.059238287107464795,
                0.028663214369642594,
                0.5415531284893763,
            ],
            [
                0.2949336072968401,
    ...
    def test_nnls_gh21021_ex3(self):
        A = np.array(
            [
                [
                    0.08247592017366788,
                    0.058398241636675674,
                    -0.1031496693415968,
                    0.03156983127072098,
                    -0.029503680182026665,
                ],
                [
                    0.21463607509982277,
                    -0.2164518969308173,
                ...
                [
                    ...
                    0.042682817961676424,
                    -0.018157525489298176,
                    0.11561953260568134,
                ],
                [
                    0.2328797918159187,
                ...
                [
                    -0.2928391429686263,
                    -0.20437574856615687,
                    -0.020892110811574407,
                    -0.10455040720819309,
                    0.05337267000160461,
                ],
                [
                    0.22041503019400316,
                    0.014262782992311842,
                    0.08274606359871121,
                    -0.17933172096518907,
                    -0.11809690350702161,
                ],
                ...
                [
                    -0.010388407673304468,
                    0.015174707581808923,
                    0.04764509565386281,
                    -0.1781221936030805,
                    0.10218894080536609,
                ],
                ...
                [
                    -0.12490006751823997,
                    -0.03012003515442302,
                    -0.051495264012509506,
                    0.012070729698374614,
                    0.04811700123118234,
                ],
                [
                    0.15254854117990788,
                    -0.051863547789218374,
                    0.058012914127346174,
                    -0.06717991061422621,
                    -0.14514671564242257,
                ],
                [
                ...
                [
                    0.2212788380372723,
                    0.02569245145758152,
                    -0.021596152392209966,
                    0.04610005150029433,
                    -0.2024454395619734,
                ],
                [
                    -0.043225338359410316,
                    0.17816095186290315,
                    -0.014709092962616079,
                    0.06993970293287989,
                    -0.09033722782555903,
                ],
                [
                    ...
                    0.06265720409894943,
                    0.0689704059061795,
                    0.024474319398401525,
                ],
                [
                    -0.1163880385601698,
                    0.29989570587630027,
                    0.033443765320984545,
                    0.008470296514656,
                    -0.0014457113271462002,
                ],
                [
                    0.024375314902718406,
                    0.05279830705548363,
                    0.02691082431023144,
                    0.05265079368002343,
                    0.15542988147487913,
        ...
        sol, res = nnls(A, b)
        assert_allclose(
            sol, np.array([0.0, 0.0, 76.3611306173957, 0.0, 0.0]), atol=5e-14
        )
        assert np.abs(np.linalg.norm(A @ sol - b) - res) < 5e-14
    ...
    def test_2D_singleton_RHS_input(self):
        ...
        A = np.array([[1.0, 0.5, -1.0], [1.0, 0.5, 0.0], [-1.0, 0.0, 1.0]])
    ...
    def test_2D_not_singleton_RHS_input_2(self):
        ...
        A = np.array(
            [[1.0, 0.5, -1.0], [1.0, 0.5, 0.0], [1.0, 0.5, 0.0], [0.0, 0.0, 1.0]]
        )
