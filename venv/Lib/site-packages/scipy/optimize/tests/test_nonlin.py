...
class TestNonlin:
    ...
    @pytest.mark.parametrize(
        "method", ["lgmres", "gmres", "bicgstab", "cgs", "minres", "tfqmr"]
    )
    ...
    def test_warnings_invalid_inner_param(self):
        ...
        with pytest.warns(UserWarning, match="Please check inner method documentation"):
        ...
        nonlin.newton_krylov(
            F, F.xin, method="minres", inner_maxiter=100, inner_callback=lambda _: ...
        )
...
class TestSecant:
    ...
    xs = [
        ...
        np.array([2.0, 3.0, 4.0, 5.0, 1.0]),
        np.array([3.0, 4.0, 5.0, 1.0, 2.0]),
        np.array([4.0, 5.0, 1.0, 2.0, 3.0]),
        np.array([9.0, 1.0, 9.0, 1.0, 3.0]),
        np.array([0.0, 1.0, 9.0, 1.0, 3.0]),
        np.array([5.0, 5.0, 7.0, 1.0, 1.0]),
        np.array([1.0, 2.0, 7.0, 5.0, 1.0]),
    ]
