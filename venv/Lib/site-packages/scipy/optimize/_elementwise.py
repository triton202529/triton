...
def find_root(f, init, /, *, args=(), tolerances=None, maxiter=None, callback=None):
    ...
    res = _chandrupatla(
        f, xl, xr, args=args, **tolerances, maxiter=maxiter, callback=_callback
    )
...
def find_minimum(f, init, /, *, args=(), tolerances=None, maxiter=100, callback=None):
    ...
    res = _chandrupatla_minimize(
        f, xl, xm, xr, args=args, **tolerances, maxiter=maxiter, callback=_callback
    )
    return reformat_result(res)


def bracket_root(
    f, xl0, xr0=None, *, xmin=None, xmax=None, factor=None, args=(), maxiter=1000
):
    ...
    res = _bracket_root(
        f, xl0, xr0=xr0, xmin=xmin, xmax=xmax, factor=factor, args=args, maxiter=maxiter
    )
