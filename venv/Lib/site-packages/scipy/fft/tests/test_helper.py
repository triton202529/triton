...
class TestFFTShift:
    ...
    def test_definition(self, xp):
        x = xp.asarray([0.0, 1, 2, 3, 4, -4, -3, -2, -1])
        y = xp.asarray([-4.0, -3, -2, -1, 0, 1, 2, 3, 4])
        xp_assert_close(fft.fftshift(x), y)
        xp_assert_close(fft.ifftshift(y), x)
        x = xp.asarray([0.0, 1, 2, 3, 4, -5, -4, -3, -2, -1])
        y = xp.asarray([-5.0, -4, -3, -2, -1, 0, 1, 2, 3, 4])
        xp_assert_close(fft.fftshift(x), y)
        xp_assert_close(fft.ifftshift(y), x)
    ...
    def test_axes_keyword(self, xp):
        freqs = xp.asarray([[0.0, 1, 2], [3, 4, -4], [-3, -2, -1]])
        shifted = xp.asarray([[-1.0, -3, -2], [2, 0, 1], [-4, 3, 4]])
    ...
    def test_uneven_dims(self, xp):
        ...
        freqs = xp.asarray([[0, 1], [2, 3], [4, 5]], dtype=xp.float64)

        # shift in dimension 0
        shift_dim0 = xp.asarray([[4, 5], [0, 1], [2, 3]], dtype=xp.float64)
