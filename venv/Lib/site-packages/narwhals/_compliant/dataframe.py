...
class CompliantDataFrame(
    ...
    @classmethod
    def from_native(
        cls, data: NativeFrameT, /, *, context: _LimitedContext
    ) -> Self: ...
    @classmethod
    def from_numpy(
        cls,
...
class EagerDataFrame(
    CompliantDataFrame[
        EagerSeriesT, EagerExprT, NativeFrameT, "DataFrame[NativeFrameT]"
    ],
    ...
    def __narwhals_namespace__(
        ...
        Self, EagerSeriesT, EagerExprT, NativeFrameT, NativeSeriesT
    ]: ...
