...
_1DArrayInt: TypeAlias = (
    "np.ndarray[tuple[int], np.dtype[np.integer[Any]]]"  # noqa: PYI042
)
...
NonNestedDType: TypeAlias = (
    "dtypes.NumericType | dtypes.TemporalType | dtypes.String | dtypes.Boolean | dtypes.Binary | dtypes.Categorical | dtypes.Unknown | dtypes.Object"
)
