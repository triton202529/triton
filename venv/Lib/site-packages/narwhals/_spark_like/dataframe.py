...
class SparkLikeLazyFrame(
    ...
    @classmethod
    def from_native(
        cls, data: SQLFrameDataFrame, /, *, context: _LimitedContext
    ) -> Self:
        return cls(
            data, version=context._version, implementation=context._implementation
        )
    ...
    def join(
        ...
        on_ = (
            ...
            if how == "full"
            else None if how == "cross" else left_on_
        )
