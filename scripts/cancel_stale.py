...
def main():
    p = argparse.ArgumentParser(
        description="Cancel stale open orders with whitelist and cutoff rules."
    )
    p.add_argument("--mode", choices=["paper", "live"], default="paper")
    p.add_argument(
        "--whitelist",
        default="",
        help="Comma-separated symbols to keep fresh (e.g. V,MRK,MSFT,META,KO)",
    )
    p.add_argument(
        "--cutoff",
        default=None,
        help='ISO cutoff (e.g. "2025-09-01" or "2025-09-01T15:30:00")',
    )
